...
exports.addTodoChanged = addTodoChanged;
...
var state = {
    todoList: [{ key: 1, id: 1, text: "Learn React", status: 1 }, { key: 2, id: 2, text: "Learn Redux", status: 1 }, { key: 3, id: 3, text: "Reduxify this app", status: 0 }, { key: 4, id: 4, text: "Learn React Native", status: 0 }],
    addTodoValue: ""
};
...
function todoListApp(state, action) {
    var newState = Object.assign({}, state);

    var todoList = newState.todoList.slice(); //.slice() to keep immutability
    var newItem = {};
    var lastId = todoList[todoList.length - 1].id;
    ...
    switch (action.type) {
        case _actions.TOGGLE_TODO:
            ...
            newState = Object.assign({}, newState, { todoList: todoList });
            break;
        ...
        case _actions.SAVE_TODO:
            newItem.id = lastId + 1;
            newItem.key = lastId + 1;
            newItem.text = newState.addTodoValue;
            newItem.status = 0;
            todoList.push(newItem);
            newState = Object.assign({}, newState, { todoList: todoList, "addTodoValue": "" });
            break;
...
var _AddNewTodo = __webpack_require__(75);

var _AddNewTodo2 = _interopRequireDefault(_AddNewTodo);
...
var Main = function Main() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_AddNewTodo2.default, null)
    );
};
...
var _Todo = __webpack_require__(74);
    ...
    _createClass(TodoList, [{
        ...
        value: function render() {
            var TODOS = this.props.TODOS.map(function (item) {
                return _react2.default.createElement(_Todo2.default, item);
            });
            return _react2.default.createElement(
                "div",
                null,
...
var Todo = function (_Component) {
    ...
    _createClass(Todo, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "li",
                { className: this.props.status ? "done" : "open", id: "todo-" + this.props.id },
                _react2.default.createElement(
                    "button",
                    { className: "todo", onClick: this.props.toggleStatus },
                    this.props.status ? "✅" : "❎"
                ),
                this.props.text
            );
...
function mapDispatchToProps(dispatch, ownProps) {
    return {
        toggleStatus: function toggleStatus() {
            return dispatch(actions.toggleStatus(ownProps.id));
        }
    };
}

exports.default = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(Todo);
...
var AddNewTodo = function (_Component) {
    _inherits(AddNewTodo, _Component);

    function AddNewTodo() {
        _classCallCheck(this, AddNewTodo);

        return _possibleConstructorReturn(this, (AddNewTodo.__proto__ || Object.getPrototypeOf(AddNewTodo)).apply(this, arguments));
    }

    _createClass(AddNewTodo, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("input", { type: "text", value: this.props.addTodoValue, onChange: this.props.addTodoChanged, placeholder: "Add New Todo" }),
                _react2.default.createElement(
                    "button",
                    { className: "add", onClick: this.props.saveNewTodo },
                    "\u2795"
                )
            );
        }
...
function mapDispatchToProps(dispatch) {
    return {
        addTodoChanged: function addTodoChanged(e) {
            return dispatch(actions.addTodoChanged(e.target.value));
        },
        saveNewTodo: function saveNewTodo() {
            return dispatch(actions.saveNewTodo());
        }
    };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(AddNewTodo);
